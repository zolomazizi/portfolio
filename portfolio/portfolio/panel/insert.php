...
if($_SERVER['REQUEST_METHOD'] == "POST"){ 
    ...
    /** Traitement Table Work */
        try{
            if(isset($_POST['title']) && isset($_POST['des']) && isset($_POST['catg'])  && isset($_POST['img'])){
                $title = $db->quote($_POST['title']);
                $des = $db->quote($_POST['des']);
                $catg = $db->quote($_POST['catg']);
                
                $img = $db->quote($_POST['img']);
                $query = "INSERT INTO items (`title`, `des`, `catg`, `img`) VALUES ($title,$des,$catg,$img)";
                ...
                <nav class="navbar navbar-expand-lg navbar-light bg">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                        <div class="navbar-nav">
                            <a class="nav-item nav-link" href="../admin/disco.php"><i class="fa fa-power-off"></i> Logout</a>
                        </div>
                    </div>
            </div>
        </nav>
        ...
        <form method="POST" action="" class="add-form container">
            ...
            <div class="form-group">
                    ...
                    <select class="form-control" name="catg">
                            ...
                            <option value="pJAVA SCRIPT">JAVA SCRIPT</option>
